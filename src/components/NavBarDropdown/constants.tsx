...
const CELL_LINE_COLLECTION_COMPONENT = (
    <div className={tubeIcon} style={{ fontSize: "14px" }}>
        <TubeIcon size={24} /> Cell Line Collection on Coriell
    </div>
);

const PLASMID_COLLECTION_COMPONENT = (
    <div className={plasmidIcon} style={{ fontSize: "14px" }}>
        <PlasmidIcon size={20} /> Plasmid Collection on addgene
    </div>
);
